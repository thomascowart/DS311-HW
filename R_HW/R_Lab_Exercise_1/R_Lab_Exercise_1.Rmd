...
matrix_uppercase_letters <- matrix(uppercase_letters, nrow = 2, ncol = 13)
```
...
Once you finished and knit the RMarkdown file into html file, you should be able to see the message "Congratulations!!  You completed the first exercise in this section!!" in the html document.
...
if (exists("x") == TRUE | exists("y") == TRUE | exists("z") == TRUE){
  if (x == 4 & y == 12 & z == 3) {
  print("Congratulations!!  You completed the first activity in this class!!")
  } else {
